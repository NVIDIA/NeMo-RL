...
@pytest.mark.parametrize(
    ...
    [
        ...
        (TEST_ASSETS.TINY_QWEN3_TIED_MODEL_PATH, 1, True, True, False),
        (TEST_ASSETS.TINY_QWEN3_TIED_MODEL_PATH, 1, True, False, True),
        (TEST_ASSETS.TINY_QWEN3_TIED_MODEL_PATH, 1, False, True, True),
        (TEST_ASSETS.TINY_QWEN3_TIED_MODEL_PATH, 1, True, True, True),
    ],
    indirect=True,
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (TEST_ASSETS.TINY_QWEN3_TIED_MODEL_PATH, 2, False, True, False),
        (TEST_ASSETS.TINY_QWEN3_TIED_MODEL_PATH, 2, False, False, False),
    ],
    indirect=True,
)
