...
class ModelFlag(Enum):
    ...
    Flags:
        SKIP_TIED_WEIGHTS_CHECK: Models that should skip the tied weights check
                                 even without setting the NRL_SKIP_TIED_WEIGHT_CHECK flag.
    ...
    SKIP_TIED_WEIGHTS_CHECK = auto()
    VLLM_LOAD_FORMAT_AUTO = auto()

    def matches(self, model_name: str) -> bool:
        match self:
            case ModelFlag.SKIP_TIED_WEIGHTS_CHECK:
