...
At the end of each stage, the user needs to specify the HuggingFace checkpoint to continue training on. To get this checkpoint,we convert a model checkpoint to a HuggingFace checkpoint with the following command:
